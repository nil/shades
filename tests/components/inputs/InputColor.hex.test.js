...
describe('ColorInput', () => {
  ...
  describe('ColorInputSingle', () => {
    test('Change value with blur', () => {
      ...
      expect(single.element.value).toBe(store.state.test.color);
      expect(store.state.test.color).toBe('#DADADA');
    });
    ...
    test('Change value with enter', () => {
      ...
      expect(single.element.value).toBe(store.state.test.color);
      expect(store.state.test.color).toBe('#000000');
    });
    ...
    test('Change value with key up', () => {
      ...
      expect(single.element.value).toBe(store.state.test.color);
      expect(store.state.test.color).toBe('#030303');
    });
    ...
    test('Change value with key up and shift', () => {
      ...
      expect(single.element.value).toBe(store.state.test.color);
      expect(store.state.test.color).toBe('#1C1C1C');
    });
    ...
    test('Change value with key down', () => {
      ...
      expect(single.element.value).toBe(store.state.test.color);
      expect(store.state.test.color).toBe('#1A1A1A');
    });
  ...
  describe('ColorPreview', () => {
    test('Color coincide with store value', () => {
      expect(preview.vm.backgroundColor).toBe(store.state.test.color);
    });
